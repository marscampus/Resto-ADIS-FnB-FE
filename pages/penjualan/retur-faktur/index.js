...
export default function MasterReturFaktur(){
    ...
    const breadcrumbItems = [{ label: 'Penjualan' }, { label: 'Retur Penjualan dengan Faktur', to:'#' }];

    let emptyreturfaktur = {
        KODE:null,
    };
    ...
    const [returFaktur, setReturFaktur] = useState(emptyreturfaktur);
    ...
    const openNew = () => {
        setReturFaktur(emptyreturfaktur);
        setSubmitted(false);
        router.push('/penjualan/retur-faktur/add');
    ...
    return (
        <div className="grid crud-demo">
            <div className="col-12">
                ...
                <div className="card">
                    <h4>Menu Retur Penjualan dengan Faktur</h4><hr/>
                    <Toast ref={toast} />
