...
export default function MasterRetur(){
    ...
    const breadcrumbItems = [{ label: 'Penjualan' }, { label: 'Retur Penjualan Tanpa Faktur', to:'#' }];
    ...
    const openNew = () => {
        setRetur(emptyretur);
        setSubmitted(false);
        router.push('/penjualan/retur/add');
    ...
    return (
        <div className="grid crud-demo">
            <div className="col-12">
                ...
                <div className="card">
                    <h4>Menu Retur Penjualan Tanpa Faktur</h4><hr/>
                    <Toast ref={toast} />
                    ...
                    {/* Dialog Retur  */}
                    <Dialog visible={returDialog} style={{ width: '75%' }} header="Tambah Retur " modal className="p-fluid" footer={returDialogFooter} onHide={hideDialog}>
                        <div className="formgrid grid">
                            <div className="field col-12 mb-2 lg:col-6">
                                <label htmlFor="kode">Kode</label>
                                <div className="p-inputgroup">
                                    <InputText disabled id="kode" value={retur.KODE} onChange={(e) => onInputChange(e, 'KODE')} className={classNames({ 'p-invalid': submitted && !retur.KODE })} />
                                </div>
                                {submitted && !retur.KODE && <small className="p-invalid">Kode is required.</small>}
                            </div>
                            <div className="field col-12 mb-2 lg:col-6">
                                <label htmlFor="keterangan">Keterangan</label>
                                <InputText id="keterangan" value={retur.Keterangan} onChange={(e) => onInputChange(e, 'Keterangan')} required autoFocus className={classNames({ 'p-invalid': submitted && !retur.Keterangan })} />
                                {submitted && !retur.KETERANGAN && <small className="p-invalid">Keterangan is required.</small>}
                            </div>
                        </div>
                    </Dialog>
                </div>
