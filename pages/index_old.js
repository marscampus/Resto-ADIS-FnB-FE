            ...
            <div className="col-12 xl:col-6">
                <div className="card">
                    ...
                    <DataTable value={products} rows={5} paginator responsiveLayout="scroll">
                        <Column headerStyle={{ textAlign: "center" }} header="Image" body={(data) => <img className="shadow-2" src={`${contextPath}/demo/images/product/${data.image}`} alt={data.image} width="50" />} />
                        <Column headerStyle={{ textAlign: "center" }} field="name" header="Name" sortable style={{ width: '35%' }} />
                        <Column headerStyle={{ textAlign: "center" }} field="price" header="Price" sortable style={{ width: '35%' }} body={(data) => formatCurrency(data.price)} />
